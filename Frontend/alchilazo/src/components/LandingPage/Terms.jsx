...
const Terms = ({setPage}) => {
    ...
    return(
        <>
            <div className="slide" style={{backgroundImage: 'url(https://images.pexels.com/photos/2067576/pexels-photo-2067576.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)'}}>
                
                <div className="center">
                    <h2>Términos y Condiciones</h2>
                    <div className="icon-wrapper">
                        <i className="flaticon-royal-crown-of-triangles-grid-design"></i>
                    </div>
                    <FootBar num={3} setPage={setPage}/>
                    ...
                    Alchilazo gestiona este sitio web. En todo el sitio, los términos "nosotros", "nos" y "nuestro" se refieren en lo sucesivo a Alchilazo. Alchilazo ofrece esta página web, incluida toda la información, las herramientas y los servicios que se ponen en este sitio a disposición suya, el usuario, siempre y cuando acepte la totalidad de los términos, condiciones, políticas y avisos contemplados aquí.<br/>
                    <br/>
                    ...
                    <br/>
                    No asumimos ninguna obligación de actualizar, modificar o aclarar la información en el Servicio o en cualquier sitio web relacionado, incluyendo de manera enunciativa pero no limitativa, la información de precios, excepto cuando lo exija la ley. Ninguna actualización especificada o fecha de actualización aplicada en el Servicio o en cualquier sitio web relacionado debe tomarse para indicar que toda la información en el Servicio o en cualquier sitio web relacionado se modificó o actualizó.<br/>
                    ...
                    SECCIÓN 13: DESCARGO DE RESPONSABILIDAD DE GARANTÍAS; LIMITACIÓN DE RESPONSABILIDAD<br/>
                    <br/>
                    ...
                    <br/>
                    Usted acepta que periódicamente, podamos eliminar el servicio por lapsos de tiempo indefinidos o cancelar el servicio en cualquier momento, sin notificarle.<br/>
                    ...
                    <br/>
                    Los presentes Términos del servicio y cualquier acuerdo por separado por el cual le proporcionemos Servicios se regirán e interpretarán de acuerdo con las leyes de zona 4 diagonal 12, Guatemala, GUA, 01009, Guatemala.<br/>
                    <br/>
                    <br/>
                    ...
                    <br/>
                    Las preguntas sobre los Términos del servicio se deben enviar a momufite.ohijoquq@rungel.net.<br/>
                    </div>
